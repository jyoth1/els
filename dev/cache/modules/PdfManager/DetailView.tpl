...
{if !$fields.body_html.hidden}
{counter name="panelFieldCount"}
<span id="body_html" class="sugar_field">{$fields.body_html.value|from_html}</span>
{/if}
</td>
{else}
<td>&nbsp;</td><td>&nbsp;</td>
...
YAHOO.util.Event.onContentReady('PdfManager_detailview_tabs', SUGAR.forms.AssignmentHandler.loadComplete);});</script>{/literal}
