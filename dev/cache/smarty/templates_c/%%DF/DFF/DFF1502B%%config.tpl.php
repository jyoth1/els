<?php /* Smarty version 2.6.11, created on 2019-05-29 15:39:31
...
>
        ...
        <td scope="row" width="17%"><?php echo $this->_tpl_vars['MOD']['LBL_ALLOW_USER_EMAIL_ACCOUNT']; ?>
:&nbsp;</td>
        <td>
            <input type='hidden' name='allow_user_email_accounts' value='0'>
            <input name="allow_user_email_accounts" tabindex='1'  value='1' class="checkbox" type="checkbox" <?php echo $this->_tpl_vars['allow_user_email_accounts']; ?>
>
        </td>
    </tr>
     <tr>
...
:
             <img border="0" class="inlineHelpTip"
                  onclick="return SUGAR.util.showHelpTips(this,'<?php echo ((is_array($_tmp=$this->_tpl_vars['MOD']['LBL_FROM_ADDRESS_HELP'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
','','','dialogHelpPopup')"
                  src="index.php?entryPoint=getImage&themeName=<?php echo $this->_tpl_vars['THEME']; ?>
&imageName=helpInline.gif">
         </td>
         <td width="30%" valign='top'><input type='hidden' name='notify_send_from_assigning_user' value='0'><input
                     ...
                     type="checkbox" <?php echo $this->_tpl_vars['notify_send_from_assigning_user']; ?>
></td>
         <td width="20%" scope="row" valign='top'>
             <?php echo $this->_tpl_vars['MOD']['LBL_EMAIL_OPT_OUT_DEFAULT']; ?>
:
             <img border="0" class="inlineHelpTip"
                  onclick="return SUGAR.util.showHelpTips(this,'<?php echo ((is_array($_tmp=$this->_tpl_vars['MOD']['LBL_EMAIL_OPT_OUT_DEFAULT_TOOLTIP'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
','','','dialogHelpPopup')"
                  src="index.php?entryPoint=getImage&themeName=<?php echo $this->_tpl_vars['THEME']; ?>
&imageName=helpInline.gif">
         </td>
         <td width="30%" valign='top'>
             ...
             <input name='new_email_addresses_opted_out' value="1" tabindex='1' class="checkbox"
                    type="checkbox" <?php echo $this->_tpl_vars['new_email_addresses_opted_out']; ?>
>
         </td>
    </tr>
</table>
