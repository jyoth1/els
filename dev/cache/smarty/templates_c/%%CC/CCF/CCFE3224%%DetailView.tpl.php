<?php /* Smarty version 2.6.11, created on 2019-05-29 16:06:43
         compiled from cache/modules/Users/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'cache/modules/Users/DetailView.tpl', 3, false),array('function', 'sugar_image', 'cache/modules/Users/DetailView.tpl', 27, false),array('function', 'sugar_csrf_form_token', 'cache/modules/Users/DetailView.tpl', 46, false),array('function', 'sugar_action_menu', 'cache/modules/Users/DetailView.tpl', 61, false),array('function', 'sugar_include', 'cache/modules/Users/DetailView.tpl', 82, false),array('function', 'counter', 'cache/modules/Users/DetailView.tpl', 87, false),array('function', 'sugar_getimagepath', 'cache/modules/Users/DetailView.tpl', 90, false),array('function', 'sugar_translate', 'cache/modules/Users/DetailView.tpl', 93, false),array('function', 'sugar_getimage', 'cache/modules/Users/DetailView.tpl', 125, false),array('function', 'sugar_ajax_url', 'cache/modules/Users/DetailView.tpl', 305, false),array('function', 'sugar_phone', 'cache/modules/Users/DetailView.tpl', 443, false),array('function', 'sugar_help', 'cache/modules/Users/DetailView.tpl', 1077, false),array('modifier', 'escape', 'cache/modules/Users/DetailView.tpl', 10, false),array('modifier', 'strip_semicolon', 'cache/modules/Users/DetailView.tpl', 108, false),array('modifier', 'url2html', 'cache/modules/Users/DetailView.tpl', 707, false),array('modifier', 'nl2br', 'cache/modules/Users/DetailView.tpl', 707, false),)), $this); ?>
...
YAHOO.SUGAR.MessageBox.show({
    title: \'';  echo ((is_array($_tmp=$this->_tpl_vars['ERROR_MESSAGE'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript'));  echo '\',
    msg: \'';  echo ((is_array($_tmp=$this->_tpl_vars['ERRORS'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript'));  echo '\'
});
'; ?>
...
<?php else: ?>
<td>&nbsp;</td><td>&nbsp;</td>
<?php endif;  if ($this->_tpl_vars['fields']['sv_site_visits_users_1_name']['acl'] > 0):  echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>

<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['sv_site_visits_users_1_name']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_SV_SITE_VISITS_USERS_1_FROM_SV_SITE_VISITS_TITLE','module' => 'Users'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php else:  echo smarty_function_counter(array('name' => 'fieldsHidden'), $this);?>
...
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['sv_site_visits_users_1_name']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['sv_site_visits_users_1sv_site_visits_ida']['value'] )):  ob_start(); ?>index.php?module=SV_Site_Visits&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['sv_site_visits_users_1sv_site_visits_ida']['value'];  $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('detail_url', ob_get_contents());ob_end_clean(); ?>
<a href="<?php echo smarty_function_sugar_ajax_url(array('url' => $this->_tpl_vars['detail_url']), $this);?>
"><?php endif; ?>
<span id="sv_site_visits_users_1sv_site_visits_ida" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['sv_site_visits_users_1sv_site_visits_ida']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['sv_site_visits_users_1_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['sv_site_visits_users_1sv_site_visits_ida']['value'] )): ?></a><?php endif;  endif; ?>
</td>
<?php else: ?>
<td>&nbsp;</td><td>&nbsp;</td>
<?php endif; ?>
...
<tr>
<td width="15%" scope="row"><slot><?php echo ((is_array($_tmp=$this->_tpl_vars['MOD']['LBL_CURRENCY_CREATE_IN_PREFERRED'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:</slot></td>
<td><slot><?php if ($this->_tpl_vars['currency_create_in_preferred']): ?>Yes<?php else: ?>No<?php endif; ?>&nbsp;</slot></td>
<td><slot><?php echo $this->_tpl_vars['MOD']['LBL_CURRENCY_CREATE_IN_PREFERRED_TEXT']; ?>
&nbsp;</slot></td>
</tr>
<tr>
