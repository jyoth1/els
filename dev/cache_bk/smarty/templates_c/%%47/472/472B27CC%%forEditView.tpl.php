...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'include/SugarEmailAddress/templates/forEditView.tpl', 25, false),array('function', 'sugar_translate', 'include/SugarEmailAddress/templates/forEditView.tpl', 39, false),array('function', 'sugar_getimage', 'include/SugarEmailAddress/templates/forEditView.tpl', 40, false),)), $this); ?>
<?php 
...
<script type="text/javascript" src="<?php echo smarty_function_sugar_getjspath(array('file' => 'include/SugarEmailAddress/SugarEmailAddress.js'), $this);?>
"></script>
...
','','');"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('other_attributes', ob_get_contents());ob_end_clean(); ?>
                        <?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ID_FF_ADD'), $this); $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('alt_addButton', ob_get_contents());ob_end_clean(); ?>
                        <button type="button" <?php echo $this->_tpl_vars['other_attributes']; ?>
><?php echo smarty_function_sugar_getimage(array('name' => "id-ff-add",'alt' => ($this->_tpl_vars['alt_addButton']),'ext' => ".png"), $this);?>
</button>
					</td>
					<td scope="row" NOWRAP>
					    &nbsp;
...
;
        eaw.idmMode = <?php echo $this->_tpl_vars['idmMode']; ?>
;
