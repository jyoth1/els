...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_csrf_form_token', 'modules/Calendar/tpls/repeat.tpl', 21, false),array('function', 'html_options', 'modules/Calendar/tpls/repeat.tpl', 28, false),array('modifier', 'default', 'modules/Calendar/tpls/repeat.tpl', 60, false),)), $this); ?>

<div id="edit_all_recurrences_block" style="display: none; margin-bottom: 10px;">
	<button type="button" id="btn-edit-all-recurrences" onclick="CAL.editAllRecurrences();"> <?php echo $this->_tpl_vars['MOD']['LBL_EDIT_ALL_RECURRENCES']; ?>
 </button>
	<button type="button" id="btn-remove-all-recurrences" onclick="CAL.removeAllRecurrences();"> <?php echo $this->_tpl_vars['MOD']['LBL_REMOVE_ALL_RECURRENCES']; ?>
 </button>
</div>
