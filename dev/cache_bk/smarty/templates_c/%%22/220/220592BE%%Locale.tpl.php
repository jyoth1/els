<?php /* Smarty version 2.6.11, created on 2019-05-24 19:01:44
         compiled from modules/Administration/Locale.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip', 'modules/Administration/Locale.tpl', 16, false),array('function', 'sugar_csrf_form_token', 'modules/Administration/Locale.tpl', 41, false),array('function', 'html_options', 'modules/Administration/Locale.tpl', 68, false),)), $this); ?>


<script type="text/javascript">
	var ERR_NO_SINGLE_QUOTE = '<?php echo ((is_array($_tmp=$this->_tpl_vars['APP']['ERR_NO_SINGLE_QUOTE'])) ? $this->_run_mod_handler('strip', true, $_tmp) : smarty_modifier_strip($_tmp)); ?>
';
	var cannotEq = "<?php echo ((is_array($_tmp=$this->_tpl_vars['APP']['ERR_DECIMAL_SEP_EQ_THOUSANDS_SEP'])) ? $this->_run_mod_handler('strip', true, $_tmp) : smarty_modifier_strip($_tmp)); ?>
";
<?php echo '
