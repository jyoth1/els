<?php /* Smarty version 2.6.11, created on 2019-05-25 13:53:02
...
:
				...
				<td>
					<?php ob_start();  echo smarty_function_sugar_translate(array('label' => $this->_tpl_vars['module_key']), $this); $this->_smarty_vars['capture']['module_label'] = ob_get_contents(); ob_end_clean(); ?>
					<input name='ignore' value="<?php echo ((is_array($_tmp=$this->_smarty_vars['capture']['module_label'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" disabled>
...
:
				...
				<td><?php if ($this->_tpl_vars['rel']['readonly']): ?>
					<input name="rhs_module" id="rhs_mod_field" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['translated_relatable'][$this->_tpl_vars['rel']['rhs_module']])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" disabled>
					<?php else: ?>
...
:</td>
                    <td><input name="lhs_label" id="lhs_label" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['rel']['lhs_label'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"  ></td>
                <?php else: ?>
                    <td></td><td><input type="hidden" name="lhs_label" id="lhs_label" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['rel']['lhs_label'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"  ></td>
                <?php endif; ?>
                <td></td>
                ...
                <td align="right" scope="row"><?php echo smarty_function_sugar_translate(array('label' => 'LBL_REL_LABEL'), $this);?>
:</td>
                <td><input name="rhs_label" id="rhs_label" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['rel']['rhs_label'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"  ></td>
                <?php else: ?>
                    <td></td><td><input type="hidden" name="rhs_label" id="rhs_label" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['rel']['rhs_label'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"  ></td>
                <?php endif; ?>
            </tr>
            <tr>
                <?php if ($this->_tpl_vars['rel']['relationship_type'] == 'many-to-many' || $this->_tpl_vars['rel']['relationship_type'] == 'many-to-one'): ?>
                <?php ob_start();  echo smarty_function_sugar_translate(array('label' => $this->_tpl_vars['rel']['lhs_module']), $this); $this->_smarty_vars['capture']['lhs_module'] = ob_get_contents(); ob_end_clean(); ?>
                <td align="right" scope="row"><?php echo $this->_tpl_vars['mod_strings']['LBL_SUBPANEL_FROM']; ?>
 <?php echo ((is_array($_tmp=$this->_smarty_vars['capture']['lhs_module'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
:</td>
                <td> <?php if ($this->_tpl_vars['rel']['readonly']): ?>
...
" disabled>
                ...
                <td></td>
                <?php if ($this->_tpl_vars['rel']['relationship_type'] != 'many-to-one'): ?>
                <?php ob_start();  echo smarty_function_sugar_translate(array('label' => $this->_tpl_vars['rel']['rhs_module']), $this); $this->_smarty_vars['capture']['rhs_module'] = ob_get_contents(); ob_end_clean(); ?>
                <td align="right" scope="row"><?php echo $this->_tpl_vars['mod_strings']['LBL_SUBPANEL_FROM']; ?>
 <?php echo ((is_array($_tmp=$this->_smarty_vars['capture']['rhs_module'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
:</td>
                <td>
                <?php if ($this->_tpl_vars['rel']['readonly']): ?>
