...
<input type='text' name='{$fields.name_advanced.name}' 
    ...
    value='{$value}' title=''      accesskey='9'  >
		...
		{if $fields.campaign_type_advanced.acl > 0}
		{counter assign=index}
	{math equation="left % right"
   		  left=$index
          right=$templateMeta.maxColumns
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='campaign_type_advanced'>{sugar_translate label='LBL_TYPE' module='Campaigns'}</label>
		</td>
	<td  nowrap="nowrap" width='30%'>
...
{html_options id='campaign_type_advanced' name='campaign_type_advanced[]' options=$fields.campaign_type_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.campaign_type_advanced.value}
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='status_advanced'>{sugar_translate label='LBL_STATUS' module='Campaigns'}</label>
		</td>
	<td  nowrap="nowrap" width='30%'>
...
{html_options id='status_advanced' name='status_advanced[]' options=$fields.status_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.status_advanced.value}
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='start_date_advanced'>{sugar_translate label='LBL_START_DATE' module='Campaigns'}</label>
		</td>
	<td  nowrap="nowrap" width='30%'>
...
{rdelim}
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='end_date_advanced'>{sugar_translate label='LBL_END_DATE' module='Campaigns'}</label>
		</td>
	<td  nowrap="nowrap" width='30%'>
