<?php 
 $GLOBALS["dictionary"]["Exp_Expenses"]=array (
  'table' => 'exp_expenses',
  'audited' => true,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'exp_expenses_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'exp_expenses_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'exp_expenses_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'exp_expenses_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'exp_expenses_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'type' => 'link',
      'vname' => 'LBL_TAGS_LINK',
      'relationship' => 'exp_expenses_tags',
      'source' => 'non-db',
      'exportable' => false,
      'duplicate_merge' => 'disabled',
    ),
    ...
    array (
      ...
      'relationship' => 'exp_expenses_commentlog',
      'source' => 'non-db',
      'exportable' => false,
      'duplicate_merge' => 'disabled',
    ),
    ...
    array (
      ...
      'relationship' => 'exp_expenses_locked_fields',
      'source' => 'non-db',
      'exportable' => false,
      'duplicate_merge' => 'disabled',
    ),
    ...
    array (
      'name' => 'team_link',
      'type' => 'link',
      'relationship' => 'exp_expenses_team',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'exp_expenses_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      'name' => 'teams',
      'type' => 'link',
      'relationship' => 'exp_expenses_teams',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'exp_expenses_assigned_user',
  ...
  array (
    ...
    'exp_expenses_activities' => 
    array (
      'lhs_module' => 'Exp_Expenses',
      'lhs_table' => 'exp_expenses',
      'lhs_key' => 'id',
      ...
      'relationship_role_column_value' => 'Exp_Expenses',
    ),
    'exp_expenses_following' => 
    array (
      'lhs_module' => 'Users',
      'lhs_table' => 'users',
      'lhs_key' => 'id',
    ...
    'exp_expenses_team_count_relationship' => 
    array (
      'lhs_module' => 'Teams',
      'lhs_table' => 'team_sets',
      'lhs_key' => 'id',
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_exp_expenses_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_exp_expenses_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',
    ...
    'name_del' => 
    array (
      'name' => 'idx_exp_expenses_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'team_set_exp_expenses' => 
    array (
      'name' => 'idx_exp_expenses_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'team_set_id',
    ...
    'acl_team_set_exp_expenses' => 
    array (
      'name' => 'idx_exp_expenses_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_exp_expenses_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
