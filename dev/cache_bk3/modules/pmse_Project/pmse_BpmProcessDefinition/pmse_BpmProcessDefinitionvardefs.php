<?php 
 $GLOBALS["dictionary"]["pmse_BpmProcessDefinition"]=array (
  ...
  array (
    ...
    'exp_expenses_locked_fields_link' => 
    array (
      'name' => 'exp_expenses_locked_fields_link',
      'vname' => 'Exp_Expenses',
      'type' => 'link',
      'relationship' => 'exp_expenses_locked_fields',
      'source' => 'non-db',
    ),
    'si_sites_locked_fields_link' => 
    array (
      'name' => 'si_sites_locked_fields_link',
      'vname' => 'Si_Sites',
      'type' => 'link',
      'relationship' => 'si_sites_locked_fields',
      'source' => 'non-db',
    ),
    'sv_site_visits_locked_fields_link' => 
    array (
      'name' => 'sv_site_visits_locked_fields_link',
      'vname' => 'SV_Site_Visits',
      'type' => 'link',
