<?php /* Smarty version 2.6.11, created on 2019-05-27 17:58:48
...
_checkbox_div_0'>
            &nbsp;
            <input id="selected_<?php echo $this->_tpl_vars['idname']; ?>
_collection_0" name="selected_<?php echo $this->_tpl_vars['idname']; ?>
_collection_0" type="checkbox"
                   class="checkbox" value="<?php echo $this->_tpl_vars['values']['primary']['id']; ?>
"
...
" <?php else: ?>
                   title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TEAM_SELECT_AS_TBSELECTED_TITLE'), $this);?>
" <?php endif; ?>/>
            </span>
        </td>
        <td>
