<?php /* Smarty version 2.6.11, created on 2019-05-27 18:01:18
         compiled from cache/modules/Campaigns/Popup.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'cache/modules/Campaigns/Popup.tpl', 8, false),array('function', 'sugar_csrf_form_token', 'cache/modules/Campaigns/Popup.tpl', 30, false),array('function', 'sugar_getimage', 'cache/modules/Campaigns/Popup.tpl', 73, false),array('function', 'sugar_action_menu', 'cache/modules/Campaigns/Popup.tpl', 126, false),array('function', 'counter', 'cache/modules/Campaigns/Popup.tpl', 131, false),array('function', 'sugar_translate', 'cache/modules/Campaigns/Popup.tpl', 136, false),array('function', 'sugar_field', 'cache/modules/Campaigns/Popup.tpl', 186, false),array('function', 'sugar_evalcolumn_old', 'cache/modules/Campaigns/Popup.tpl', 190, false),array('function', 'sugar_currency_format', 'cache/modules/Campaigns/Popup.tpl', 192, false),array('function', 'multienum_to_array', 'cache/modules/Campaigns/Popup.tpl', 217, false),array('modifier', 'default', 'cache/modules/Campaigns/Popup.tpl', 134, false),array('modifier', 'lower', 'cache/modules/Campaigns/Popup.tpl', 136, false),)), $this); ?>
...
>
						...
						<?php elseif ($this->_tpl_vars['params']['type'] == 'bool'): ?>
								...
								<?php endif; ?>
								/>
                        <?php elseif ($this->_tpl_vars['params']['type'] == 'teamset'): ?>
                            <<?php echo ((is_array($_tmp=@$this->_tpl_vars['pageData']['tag'][$this->_tpl_vars['id']][$this->_tpl_vars['params']['ACLTag']])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['pageData']['tag'][$this->_tpl_vars['id']]['MAIN']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['pageData']['tag'][$this->_tpl_vars['id']]['MAIN'])); ?>
 href='javascript:void(0)' onclick="send_back('<?php if ($this->_tpl_vars['params']['dynamic_module']):  echo $this->_tpl_vars['rowData'][$this->_tpl_vars['params']['dynamic_module']];  else:  echo ((is_array($_tmp=@$this->_tpl_vars['params']['module'])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['pageData']['bean']['moduleDir']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['pageData']['bean']['moduleDir']));  endif; ?>','<?php echo ((is_array($_tmp=@$this->_tpl_vars['rowData'][$this->_tpl_vars['params']['id']])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['rowData']['ID']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['rowData']['ID'])); ?>
');">
...
<a href="javascript:toggleMore('div_<?php echo $this->_tpl_vars['rowData']['ID']; ?>
...
');" style='text-decoration:none;' onMouseOver="javascript:toggleMore('div_<?php echo $this->_tpl_vars['rowData']['ID']; ?>
_teams','img_<?php echo $this->_tpl_vars['rowData']['ID']; ?>
_teams', 'Teams', 'DisplayInlineTeams', 'team_set_id=<?php echo $this->_tpl_vars['rowData']['TEAM_SET_ID']; ?>
&team_id=<?php echo $this->_tpl_vars['rowData']['TEAM_ID']; ?>
...
?>
								...
								<?php endforeach; endif; unset($_from); ?>
                        <?php elseif ($this->_tpl_vars['params']['type'] == 'url'): ?>
                            <?php $this->assign('fieldKey', ((is_array($_tmp=$this->_tpl_vars['col'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp))); ?>
                            <?php echo smarty_function_sugar_field(array('parentFieldArray' => $this->_tpl_vars['rowData'],'vardef' => $this->_tpl_vars['fields'][$this->_tpl_vars['fieldKey']],'displayType' => 'ListView','field' => $this->_tpl_vars['col']), $this);?>
