<?php /* Smarty version 2.6.11, created on 2019-05-27 18:00:01
         compiled from cache/modules/Campaigns/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Campaigns/SearchForm_popup_query_form.tpl', 28, false),array('function', 'math', 'cache/modules/Campaigns/SearchForm_popup_query_form.tpl', 29, false),array('function', 'sugar_getimagepath', 'cache/modules/Campaigns/SearchForm_popup_query_form.tpl', 37, false),array('function', 'sugar_translate', 'cache/modules/Campaigns/SearchForm_popup_query_form.tpl', 46, false),array('function', 'html_options', 'cache/modules/Campaigns/SearchForm_popup_query_form.tpl', 88, false),array('function', 'sugar_getimage', 'cache/modules/Campaigns/SearchForm_popup_query_form.tpl', 152, false),array('modifier', 'default', 'cache/modules/Campaigns/SearchForm_popup_query_form.tpl', 162, false),)), $this); ?>
...
' title=''      accesskey='9'  >
		...
		<?php if ($this->_tpl_vars['fields']['campaign_type_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='campaign_type_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE','module' => 'Campaigns'), $this);?>
</label>
		</td>
	<td  nowrap="nowrap" width='30%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='status_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'Campaigns'), $this);?>
</label>
		</td>
	<td  nowrap="nowrap" width='30%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='start_date_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_START_DATE','module' => 'Campaigns'), $this);?>
</label>
		</td>
	<td  nowrap="nowrap" width='30%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='end_date_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_END_DATE','module' => 'Campaigns'), $this);?>
</label>
		</td>
	<td  nowrap="nowrap" width='30%'>
...
<tr>
	<td colspan='2'>
    <a class='tabFormAdvLink' id='tabFormAdvLink' href='javascript:toggleInlineSearch()' title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ALT_SHOW_OPTIONS'), $this);?>
">
        <?php echo smarty_function_sugar_getimage(array('alt' => $this->_tpl_vars['alt_show_hide'],'name' => 'advanced_search','ext' => ".gif",'other_attributes' => 'border="0" class="tabFormAdvLink-icon tabFormAdvLink-advanced" '), $this); echo smarty_function_sugar_getimage(array('alt' => $this->_tpl_vars['alt_show_hide'],'name' => 'basic_search','ext' => ".gif",'other_attributes' => 'border="0" class="tabFormAdvLink-icon tabFormAdvLink-basic" '), $this);?>
