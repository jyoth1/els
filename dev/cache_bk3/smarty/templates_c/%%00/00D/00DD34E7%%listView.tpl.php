<?php /* Smarty version 2.6.11, created on 2019-05-27 16:40:45
         compiled from modules/ModuleBuilder/tpls/listView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'modules/ModuleBuilder/tpls/listView.tpl', 13, false),array('modifier', 'substr', 'modules/ModuleBuilder/tpls/listView.tpl', 86, false),array('function', 'sugar_csrf_form_token', 'modules/ModuleBuilder/tpls/listView.tpl', 14, false),array('function', 'sugar_getjspath', 'modules/ModuleBuilder/tpls/listView.tpl', 32, false),array('function', 'sugar_translate', 'modules/ModuleBuilder/tpls/listView.tpl', 39, false),array('function', 'counter', 'modules/ModuleBuilder/tpls/listView.tpl', 47, false),array('function', 'math', 'modules/ModuleBuilder/tpls/listView.tpl', 51, false),array('function', 'sugar_getimage', 'modules/ModuleBuilder/tpls/listView.tpl', 78, false),array('function', 'sugar_getimagepath', 'modules/ModuleBuilder/tpls/listView.tpl', 84, false),)), $this); ?>
<form name='edittabs' id='edittabs' method='POST' action='index.php'<?php if (isset ( $this->_tpl_vars['onsubmit'] )): ?> onsubmit="<?php echo ((is_array($_tmp=$this->_tpl_vars['onsubmit'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"<?php endif; ?>>
...
' class='draggable' data-name="<?php echo $this->_tpl_vars['key']; ?>
">
    <table width='100%'>
        <tr>
...
</span> <span style="display:none"><?php echo $this->_tpl_vars['value']['units']; ?>
</span>
                <?php else: ?>
                <span id='subslot<?php echo $this->_tpl_vars['modCounter']; ?>
width'><?php echo $this->_tpl_vars['value']['width']; ?>
</span> <span><?php echo $this->_tpl_vars['value']['units']; ?>
</span>
                <?php endif; ?>
            </td>
        </tr>
...
<script>
studiotabs.tabLabelToValue['<?php echo ((is_array($_tmp=$this->_tpl_vars['value']['label'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript', 'UTF-8') : smarty_modifier_escape($_tmp, 'javascript', 'UTF-8')); ?>
|<?php echo ((is_array($_tmp=$this->_tpl_vars['key'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript', 'UTF-8') : smarty_modifier_escape($_tmp, 'javascript', 'UTF-8')); ?>
'] = '<?php echo ((is_array($_tmp=$this->_tpl_vars['key'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript', 'UTF-8') : smarty_modifier_escape($_tmp, 'javascript', 'UTF-8')); ?>
';
if(typeof(studiotabs.subtabModules['subslot<?php echo $this->_tpl_vars['modCounter']; ?>
']) == 'undefined') {
    studiotabs.subtabModules['subslot<?php echo $this->_tpl_vars['modCounter']; ?>
'] =
            '<?php echo ((is_array($_tmp=$this->_tpl_vars['value']['label'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript', 'UTF-8') : smarty_modifier_escape($_tmp, 'javascript', 'UTF-8')); ?>
|<?php echo ((is_array($_tmp=$this->_tpl_vars['key'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript', 'UTF-8') : smarty_modifier_escape($_tmp, 'javascript', 'UTF-8')); ?>
';
}
</script>
