<?php /* Smarty version 2.6.11, created on 2019-05-27 19:55:43
         compiled from cache/modules/Import/SV_Site_Visitsreview_audit_performed_c.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'cache/modules/Import/SV_Site_Visitsreview_audit_performed_c.tpl', 9, false),array('function', 'sugar_getimagepath', 'cache/modules/Import/SV_Site_Visitsreview_audit_performed_c.tpl', 35, false),array('modifier', 'lookup', 'cache/modules/Import/SV_Site_Visitsreview_audit_performed_c.tpl', 30, false),array('modifier', 'count', 'cache/modules/Import/SV_Site_Visitsreview_audit_performed_c.tpl', 135, false),)), $this); ?>


<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
	<select name="default_value_review_audit_performed_c" 
	id="default_value_review_audit_performed_c" 
	title=''  tabindex="1"       
	>

	<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['review_audit_performed_c']['options'],'selected' => $this->_tpl_vars['fields']['review_audit_performed_c']['value']), $this);?>

	</select>
<?php else: ?>
	<?php $this->assign('field_options', $this->_tpl_vars['fields']['review_audit_performed_c']['options']); ?>
	<?php ob_start();  echo $this->_tpl_vars['fields']['review_audit_performed_c']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
	<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
	<?php ob_start();  echo $this->_tpl_vars['fields']['review_audit_performed_c']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
	<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>

			<select style='display:none' name="default_value_review_audit_performed_c" 
		id="default_value_review_audit_performed_c" 
		title=''  tabindex="1"          
		>
	...
	<input
		id="default_value_review_audit_performed_c-input"
		name="default_value_review_audit_performed_c-input"
		size="30"
...
" id="default_value_review_audit_performed_c-image"></button><button type="button"
	        id="btn-clear-default_value_review_audit_performed_c-input"
	        title="Clear"
	        onclick="SUGAR.clearRelateField(this.form, 'default_value_review_audit_performed_c-input', 'default_value_review_audit_performed_c');sync_default_value_review_audit_performed_c()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
	</span>
...
default_value_review_audit_performed_c<?php echo '");
...
.inputNode = Y.one('#default_value_review_audit_performed_c-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#default_value_review_audit_performed_c-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#default_value_review_audit_performed_c');
...
default_value_review_audit_performed_c<?php echo '");
			...
			//global variable 
			sync_'; ?>
default_value_review_audit_performed_c<?php echo ' = function(){
				SyncToHidden();
			}
...
default_value_review_audit_performed_c-input<?php echo '\'))
						SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("'; ?>
default_value_review_audit_performed_c<?php echo '", syncFromHiddenToWidget);
		'; ?>
