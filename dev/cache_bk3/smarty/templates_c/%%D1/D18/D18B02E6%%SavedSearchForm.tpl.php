...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'modules/SavedSearch/SavedSearchForm.tpl', 23, false),array('modifier', 'default', 'modules/SavedSearch/SavedSearchForm.tpl', 46, false),array('modifier', 'escape', 'modules/SavedSearch/SavedSearchForm.tpl', 46, false),)), $this); ?>
...
";
	selectedSortOrder = "<?php echo ((is_array($_tmp=((is_array($_tmp=@$this->_tpl_vars['selectedSortOrder'])) ? $this->_run_mod_handler('default', true, $_tmp, 'DESC') : smarty_modifier_default($_tmp, 'DESC')))) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
";
	selectedOrderBy = "<?php echo ((is_array($_tmp=$this->_tpl_vars['selectedOrderBy'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
";
