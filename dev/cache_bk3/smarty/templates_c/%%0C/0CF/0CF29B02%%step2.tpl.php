<?php /* Smarty version 2.6.11, created on 2019-05-27 19:54:50
         compiled from modules/Import/tpls/step2.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_csrf_form_token', 'modules/Import/tpls/step2.tpl', 29, false),array('function', 'sugar_help', 'modules/Import/tpls/step2.tpl', 45, false),array('modifier', 'escape', 'modules/Import/tpls/step2.tpl', 34, false),array('modifier', 'upper', 'modules/Import/tpls/step2.tpl', 82, false),)), $this); ?>
<?php echo '
...
">
<input type="hidden" name="custom_delimiter_other" value="<?php echo $this->_tpl_vars['CUSTOM_DELIMITER_OTHER']; ?>
">
<input type="hidden" name="custom_enclosure" value="<?php echo $this->_tpl_vars['CUSTOM_ENCLOSURE']; ?>
">
<input type="hidden" name="source" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['SOURCE'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'UTF-8') : smarty_modifier_escape($_tmp, 'html', 'UTF-8')); ?>
">
...
?>
          <tr id="custom_import_<?php echo ($this->_foreach['saved']['iteration']-1); ?>
" class="preset-row preset-custom">
