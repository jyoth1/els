<?php /* Smarty version 2.6.11, created on 2019-05-27 19:55:44
         compiled from cache/modules/Import/SV_Site_Visitscategory_id.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'cache/modules/Import/SV_Site_Visitscategory_id.tpl', 9, false),array('function', 'sugar_getimagepath', 'cache/modules/Import/SV_Site_Visitscategory_id.tpl', 35, false),array('modifier', 'lookup', 'cache/modules/Import/SV_Site_Visitscategory_id.tpl', 30, false),array('modifier', 'count', 'cache/modules/Import/SV_Site_Visitscategory_id.tpl', 135, false),)), $this); ?>


<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
	<select name="default_value_category_id" 
	id="default_value_category_id" 
	title=''  tabindex="1"       
	>
...
<?php else: ?>
	...
	<?php ob_start();  echo $this->_tpl_vars['fields']['category_id']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
	<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
	<?php ob_start();  echo $this->_tpl_vars['fields']['category_id']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
	<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>

			<select style='display:none' name="default_value_category_id" 
		id="default_value_category_id" 
		title=''  tabindex="1"          
		>
	...
	<input
		id="default_value_category_id-input"
		name="default_value_category_id-input"
		size="30"
...
" id="default_value_category_id-image"></button><button type="button"
	        id="btn-clear-default_value_category_id-input"
	        title="Clear"
	        onclick="SUGAR.clearRelateField(this.form, 'default_value_category_id-input', 'default_value_category_id');sync_default_value_category_id()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
	</span>
...
default_value_category_id<?php echo '");
...
.inputNode = Y.one('#default_value_category_id-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#default_value_category_id-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#default_value_category_id');
...
default_value_category_id<?php echo '");
			...
			//global variable 
			sync_'; ?>
default_value_category_id<?php echo ' = function(){
				SyncToHidden();
			}
