 ...
 */
SUGAR.FunctionMap = {
	'getListWhere'	:	SUGAR.expressions.SugarListWhereExpression,	'createList'	:	SUGAR.expressions.DefineEnumExpression,	'enum'	:	SUGAR.expressions.DefineEnumExpression,	'forecastIncludedCommitStages'	:	SUGAR.expressions.ForecastIncludedCommitStagesExpression,	'getDropdownValueSet'	:	SUGAR.expressions.SugarTranslatedDropDownExpression,	'getTransDD'	:	SUGAR.expressions.SugarTranslatedDropDownExpression,	'getDropdownKeySet'	:	SUGAR.expressions.SugarDropDownExpression,	'getDD'	:	SUGAR.expressions.SugarDropDownExpression,	'forecastSalesStages'	:	SUGAR.expressions.ForecastSalesStageExpression,	'rollupMin'	:	SUGAR.expressions.MinRelatedExpression,	'divide'	:	SUGAR.expressions.DivideExpression,	'currencyDivide'	:	SUGAR.expressions.DivideExpression,	'div'	:	SUGAR.expressions.DivideExpression,	'strlen'	:	SUGAR.expressions.StringLengthExpression,	'min'	:	SUGAR.expressions.MinimumExpression,	'abs'	:	SUGAR.expressions.AbsoluteValueExpression,	'max'	:	SUGAR.expressions.MaximumExpression,	'log'	:	SUGAR.expressions.LogExpression,	'rollupMax'	:	SUGAR.expressions.MaxRelatedExpression,	'floor'	:	SUGAR.expressions.FloorExpression,	'pow'	:	SUGAR.expressions.PowerExpression,	'stddev'	:	SUGAR.expressions.StandardDeviationExpression,	'add'	:	SUGAR.expressions.AddExpression,	'currencyAdd'	:	SUGAR.expressions.AddExpression,	'countConditional'	:	SUGAR.expressions.CountConditionalRelatedExpression,	'ln'	:	SUGAR.expressions.NaturalLogExpression,	'average'	:	SUGAR.expressions.AverageExpression,	'avg'	:	SUGAR.expressions.AverageExpression,	'multiply'	:	SUGAR.expressions.MultiplyExpression,	'currencyMultiply'	:	SUGAR.expressions.MultiplyExpression,	'mul'	:	SUGAR.expressions.MultiplyExpression,	'indexOf'	:	SUGAR.expressions.IndexOfExpression,	'negate'	:	SUGAR.expressions.NegateExpression,	'count'	:	SUGAR.expressions.CountRelatedExpression,	'number'	:	SUGAR.expressions.ValueOfExpression,	'round'	:	SUGAR.expressions.RoundExpression,	'median'	:	SUGAR.expressions.MedianExpression,	'subtract'	:	SUGAR.expressions.SubtractExpression,	'currencySubtract'	:	SUGAR.expressions.SubtractExpression,	'sub'	:	SUGAR.expressions.SubtractExpression,	'rollupSum'	:	SUGAR.expressions.SumRelatedExpression,	'rollupCurrencySum'	:	SUGAR.expressions.SumRelatedExpression,	'rollupConditionalSum'	:	SUGAR.expressions.SumConditionalRelatedExpression,	'ceil'	:	SUGAR.expressions.CeilingExpression,	'ceiling'	:	SUGAR.expressions.CeilingExpression,	'rollupAve'	:	SUGAR.expressions.AverageRelatedExpression,	'rollupAvg'	:	SUGAR.expressions.AverageRelatedExpression,	'currencyRate'	:	SUGAR.expressions.CurrencyRateExpression,	'valueAt'	:	SUGAR.expressions.IndexValueExpression,	'related'	:	SUGAR.expressions.RelatedFieldExpression,	'sugarField'	:	SUGAR.expressions.SugarFieldExpression,	'ifElse'	:	SUGAR.expressions.ConditionExpression,	'cond'	:	SUGAR.expressions.ConditionExpression,	'isAlphaNumeric'	:	SUGAR.expressions.IsAlphaNumericExpression,	'isForecastClosedWon'	:	SUGAR.expressions.IsForecastClosedWonExpression,	'isInList'	:	SUGAR.expressions.IsInEnumExpression,	'isInEnum'	:	SUGAR.expressions.IsInEnumExpression,	'isValidEmail'	:	SUGAR.expressions.IsValidEmailExpression,	'isNumeric'	:	SUGAR.expressions.IsNumericExpression,	'not'	:	SUGAR.expressions.NotExpression,	'isAfter'	:	SUGAR.expressions.isAfterExpression,	'or'	:	SUGAR.expressions.OrExpression,	'greaterThan'	:	SUGAR.expressions.GreaterThanExpression,	'isValidTime'	:	SUGAR.expressions.IsValidTimeExpression,	'doBothExist'	:	SUGAR.expressions.BinaryDependencyExpression,	'and'	:	SUGAR.expressions.AndExpression,	'isValidPhone'	:	SUGAR.expressions.IsValidPhoneExpression,	'isForecastClosedLost'	:	SUGAR.expressions.IsForecastClosedLostExpression,	'isValidDate'	:	SUGAR.expressions.IsValidDateExpression,	'isForecastClosed'	:	SUGAR.expressions.IsForecastClosedExpression,	'isAlpha'	:	SUGAR.expressions.IsAlphaExpression,	'isWithinRange'	:	SUGAR.expressions.IsInRangeExpression,	'isValidDBName'	:	SUGAR.expressions.IsValidDBNameExpression,	'isRequiredCollection'	:	SUGAR.expressions.IsRequiredCollectionExpression,	'isBefore'	:	SUGAR.expressions.isBeforeExpression,	'equal'	:	SUGAR.expressions.EqualExpression,	'concat'	:	SUGAR.expressions.ConcatenateExpression,	'subStr'	:	SUGAR.expressions.SubStrExpression,	'forecastCommitStage'	:	SUGAR.expressions.ForecastCommitStageExpression,	'strToLower'	:	SUGAR.expressions.StrToLowerExpression,	'formatName'	:	SUGAR.expressions.FormatedNameExpression,	'charAt'	:	SUGAR.expressions.CharacterAtExpression,	'toString'	:	SUGAR.expressions.DefineStringExpression,	'string'	:	SUGAR.expressions.DefineStringExpression,	'contains'	:	SUGAR.expressions.ContainsExpression,	'strToUpper'	:	SUGAR.expressions.StrToUpperExpression,	'translateLabel'	:	SUGAR.expressions.SugarTranslateExpression,	'translate'	:	SUGAR.expressions.SugarTranslateExpression,	'getDropdownValue'	:	SUGAR.expressions.SugarDropDownValueExpression,	'getDDValue'	:	SUGAR.expressions.SugarDropDownValueExpression,	'hoursUntil'	:	SUGAR.expressions.HoursUntilExpression,	'now'	:	SUGAR.expressions.NowExpression,	'daysUntil'	:	SUGAR.expressions.DaysUntilExpression,	'maxRelatedDate'	:	SUGAR.expressions.MaxRelatedDateExpression,	'monthofyear'	:	SUGAR.expressions.MonthOfYearExpression,	'addDays'	:	SUGAR.expressions.AddDaysExpression,	'timestamp'	:	SUGAR.expressions.TimestampExpression,	'dayofweek'	:	SUGAR.expressions.DayOfWeekExpression,	'date'	:	SUGAR.expressions.DefineDateExpression,	'today'	:	SUGAR.expressions.TodayExpression,	'hourOfDay'	:	SUGAR.expressions.HourOfDayExpression,	'time'	:	SUGAR.expressions.DefineTimeExpression};
/**
 * The function to object map that is used by the Parser
 * to parse expressions into objects.
 */
