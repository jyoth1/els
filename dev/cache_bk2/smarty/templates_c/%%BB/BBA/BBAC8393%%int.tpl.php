<?php /* Smarty version 2.6.11, created on 2019-05-27 10:13:59
         compiled from modules/DynamicFields/templates/Fields/Forms/int.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'modules/DynamicFields/templates/Fields/Forms/int.tpl', 19, false),array('modifier', 'default', 'modules/DynamicFields/templates/Fields/Forms/int.tpl', 66, false),)), $this); ?>
<script>
...
'>
		<?php if (isset ( $this->_tpl_vars['field_range_value'] )): ?>
            <script>addToValidateRange('popup_form', 'default', 'int', false, '<?php echo smarty_function_sugar_translate(array('module' => 'DynamicFields','label' => 'COLUMN_TITLE_DEFAULT_VALUE'), $this);?>
',<?php echo $this->_tpl_vars['field_range_value']['min']; ?>
,<?php echo $this->_tpl_vars['field_range_value']['max']; ?>
);</script>
        <?php else: ?>
...
'>
		<?php if (isset ( $this->_tpl_vars['field_range_value'] )): ?>
            <script>addToValidateRange('popup_form', 'min', 'int', false, '<?php echo smarty_function_sugar_translate(array('module' => 'DynamicFields','label' => 'COLUMN_TITLE_MIN_VALUE'), $this);?>
',<?php echo $this->_tpl_vars['field_range_value']['min']; ?>
,<?php echo $this->_tpl_vars['field_range_value']['max']; ?>
);</script>
        <?php else: ?>
...
'>
		<?php if (isset ( $this->_tpl_vars['field_range_value'] )): ?>
            <script>addToValidateRange('popup_form', 'max', 'int', false, '<?php echo smarty_function_sugar_translate(array('module' => 'DynamicFields','label' => 'COLUMN_TITLE_MAX_VALUE'), $this);?>
',<?php echo $this->_tpl_vars['field_range_value']['min']; ?>
,<?php echo $this->_tpl_vars['field_range_value']['max']; ?>
);</script>
        <?php else: ?>
