...
$mod_strings = array (
  ...
  array (
    ...
    'subPanelEditor' => 
    array (
      'modify' => 'Všetky polia, ktoré môžu byť zobrazené v časti <b>Podpanel</b>, sa zobrazia tu.<br><br>Stĺpec <b>Predvolené</b> obsahuje polia, ktoré sú zobrazené v časti Podpanel. <br/> <br/>Stĺpec <b>Skryté</b> obsahuje polia, ktoré možno pridať do stĺpca Predvolené.<br/> <br/> <!--not_in_theme!--> <img src="themes/default/images/SugarLogic/icon_dependent.png"/> Označuje závislé pole, ktoré môže alebo nemusí byť viditeľné v závislosti od hodnoty vzorca. <br/> <!--not_in_theme!--> <img src="themes/default/images/SugarLogic/icon_calculated.png" /> Označuje vypočítavané pole, ktorého hodnota sa automaticky určí na základe vzorca.',
    ...
    'popupListViewEditor' => 
    array (
      'modify' => 'Všetky polia, ktoré môžu byť zobrazené v časti <b>Náhľad zoznamu</b>, sa zobrazia tu.<br><br>Stĺpec <b>Predvolené</b> obsahuje polia, ktoré sú zobrazené v náhľade zoznamu. <br/> <br/> Stĺpec <b>Skryté</b> obsahuje polia, ktoré možno pridať do stĺpca Predvolené alebo Dostupné.<br/> <br/> <!--not_in_theme!--> <img src="themes/default/images/SugarLogic/icon_dependent.png"/> Označuje závislé pole, ktoré môže alebo nemusí byť viditeľné v závislosti od hodnoty vzorca. <br/> <!--not_in_theme!--> <img src="themes/default/images/SugarLogic/icon_calculated.png" /> Označuje vypočítavané pole, ktorého hodnota sa automaticky určí na základe vzorca.',
      'savebtn' => 'Kliknutím na možnosť <b>Uložiť a použiť</b> uložte vykonané zmeny, aby sa prejavili v danom module.',
      'historyBtn' => 'Kliknutím na možnosť <b>Zobraziť históriu</b> zobrazte a obnovte predtým uložené rozloženie z histórie. <br><br>Funkcia <b>Obnoviť</b> v časti <b>Zobraziť históriu</b> obnoví umiestnenie poľa v rámci predtým uložených rozložení. Ak chcete zmeniť označenia poľa, kliknite na ikonu Upraviť vedľa daného poľa.',
      'historyRestoreDefaultLayout' => 'Kliknutím na možnosť <b>Obnoviť predvolené rozloženie</b> obnovte zobrazenie na pôvodné rozloženie. <br><br>Funkcia <b>Obnoviť predvolené rozloženie</b> obnoví iba umiestnenie poľa v rámci pôvodného rozloženia. Ak chcete zmeniť označenia polí, kliknite na ikonu Editovať vedľa daného poľa.',
      'Hidden' => '<b>Skryté</b> polia momentálne nie sú dostupné pre používateľov v náhľadoch zoznamu.',
    ...
    'searchViewEditor' => 
    array (
      'modify' => 'Všetky polia, ktoré môžu byť zobrazené v časti <b>Vyhľadávanie</b>, sa zobrazia tu.<br><br>Stĺpec <b>Predvolené</b> obsahuje polia, ktoré sú zobrazené v časti Vyhľadávanie. <br/> <br/>Stĺpec <b>Skryté</b> obsahuje polia, ktoré administrátor môže pridať do formulára Vyhľadávanie.<br/> <br/> <!--not_in_theme!--> <img src="themes/default/images/SugarLogic/icon_dependent.png"/> Označuje závislé pole, ktoré môže alebo nemusí byť viditeľné v závislosti od hodnoty vzorca. <br/> <!--not_in_theme!--> <img src="themes/default/images/SugarLogic/icon_calculated.png" /> Označuje vypočítavané pole, ktorého hodnota sa automaticky určí na základe vzorca.<br/> <br/> Táto konfigurácia sa týka len rozloženia kontextového vyhľadávania v starších moduloch.',
    ...
    'layoutEditor' => 
    array (
      'defaultdetailview' => 'Oblasť <b>Rozloženie</b> obsahuje polia, ktoré sa momentálne zobrazujú v časti <b>Zobrazenie podrobností</b>. <br/> <br/> Časť <b>Nástroje</b> obsahuje <b>Kôš</b> a polia a prvky rozloženia, ktoré do rozloženia možno pridať. <br><br>Vykonajte zmeny v rozložení pretiahnutím prvkov a polí medzi časťami <b>Nástroje</b> a <b>Rozloženie</b> a v rámci samotného rozloženia. <br> <br>Ak chcete pole z rozloženia odstrániť, pretiahnite pole do priečinka <b>Kôš</b>. Pole potom bude k dispozícii v časti Nástroje na prípadne pridanie do rozloženia.<br/> <br/> <!--not_in_theme!--> <img src="themes/default/images/SugarLogic/icon_dependent.png"/> Označuje závislé pole, ktoré môže alebo nemusí byť viditeľné v závislosti od hodnoty vzorca. <br/> <!--not_in_theme!--> <img src="themes/default/images/SugarLogic/icon_calculated.png" /> Označuje vypočítavané pole, ktorého hodnota sa automaticky určí na základe vzorca.',
      'defaultquickcreate' => 'Oblasť <b>Rozloženie</b> obsahuje polia, ktoré sa momentálne zobrazujú vo formulári <b>Rýchle vytvorenie</b>.<br><br>Formulár Rýchle vytvorenie sa zobrazuje v podpaneloch pre modul pri kliknutí na tlačidlo Vytvoriť.<br/><br/>Časť <b>Nástroje</b> obsahuje <b>Kôš</b> a polia a prvky rozloženia, ktoré do rozloženia možno pridať.<br><br>Vykonajte zmeny v rozložení pretiahnutím prvkov a polí medzi časťami <b>Nástroje</b> a <b>Rozloženie</b> a v rámci samotného rozloženia.<br><br>Ak chcete pole z rozloženia odstrániť, pretiahnite pole do priečinka <b>Kôš</b>. Pole potom bude k dispozícii v časti Nástroje na prípadné pridanie do rozloženia.<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Označuje závislé pole, ktoré môže alebo nemusí byť viditeľné v závislosti od hodnoty vzorca.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Označuje vypočítavané pole, ktorého hodnota sa automaticky určí na základe vzorca.',
...
',
  ...
  'LBL_CONFIRM_FIELD_DELETE' => 'Vymazaním tohto vlastného poľa odstránite vlastné pole a všetky údaje súvisiace s vlastným poľom v databáze. Pole sa už nebude zobrazovať v žiadnom z rozložení modulu. Ak je pole zahrnuté vo vzorci na výpočet hodnôt pre všetky polia, vzorec prestane fungovať.\\n\\nPole už bude k dispozícii na použitie v hláseniach, táto zmena sa prejaví po odhlásení a opätovnom prihlásení do aplikácie. Všetky hlásenia, ktoré obsahujú pole, bude treba aktualizovať, aby ich bolo možné spustiť.\\n\\nChcete pokračovať?',
  'LBL_CONFIRM_RELATIONSHIP_DELETE' => 'Naozaj chcete vymazať tento vzťah?<br>Poznámka: Vykonávanie tejto operácie môže trvať niekoľko minút.',
  ...
  'LBL_POPHELP_DUPLICATE_MERGE' => '<b>Povolené</b>: pole sa zobrazí vo funkcii Zlúčenie duplikátov, ale nebude k dispozícii na použitie pre podmienky filtrovania vo funkcii Vyhľadávanie duplikátov. <br><b>Blokované</b>: pole sa nezobrazí vo funkcii Zlúčenie duplikátov a nebude k dispozícii ani na použitie pre podmienky filtrovania vo funkcii Vyhľadávanie duplikátov.<br><b>Vo filtri</b>: pole sa zobrazí vo funkcii Zlúčenie duplikátov a bude k dispozícii aj vo funkcii Vyhľadávanie duplikátov. <br><b>Iba filter</b>: pole sa nezobrazí vo funkcii Zlúčenie duplikátov, ale bude k dispozícii vo funkcii Vyhľadávanie duplikátov. <br><b>Predvolene vybratý filter</b>: pole sa predvolene použije pre podmienky filtrovania na stránke vyhľadávania duplikátov a zobrazí sa aj vo funkcii Zlúčenie duplikátov.',
  'LBL_POPHELP_CALCULATED' => 'Vytvorte vzorec na určenie hodnoty v tomto poli.<br>Definície pracovného postupu obsahujúce akciu, ktoré sú nastavené na aktualizáciu tohto poľa, už nebudú vykonávať danú akciu.<br>Polia používajúce vzorce sa nebudú vypočítavať v reálnom čase v samoobslužný portál Sugar alebo Rozloženia Zobrazenia na úpravy pre mobilné telefóny.',
  'LBL_POPHELP_DEPENDENT' => 'Vytvorte vzorec na určenie, či je toto pole viditeľné v rozloženiach.<br/>Závislé polia sa budú riadiť vzorcom závislosti v mobilnom zobrazení založenom na prehliadači, <br/>ale nebudú sa riadiť vzorcom v natívnych aplikáciách, napríklad Sugar Mobile pre iPhone. <br/>Nebudú sa riadiť vzorcom v samoobslužnom portáli Sugar.',
  'LBL_POPHELP_GLOBAL_SEARCH' => 'Pri vyhľadávaní záznamov s použitím globálneho vyhľadávania na tomto module si vyberte použitie tohto poľa.',
  'LBL_RESET' => 'Obnoviť',
  ...
  'LBL_POPHELP_VALIDATE_US_PHONE' => 'Vyberte túto možnosť, ak chcete potvrdiť platnosť tohto poľa pre zadanie 10-miestneho<br>telefónneho čísla s kapacitou pre kód krajiny 1 a <br>použiť pri ukladaní záznamu pre telefónne číslo formát USA.<br>Použije sa nasledujúci formát: (xxx) xxx-xxxx.',
