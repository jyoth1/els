...
$mod_strings = array (
  ...
  array (
    ...
    'subPanelEditor' => 
    array (
      'modify' => 'Kõik väljad, mida saab kuvada kohas <b>Alampaneel</b>, kuvatakse siin.<br><br>Veerg <b>Vaikimisi</b> sisaldab alampaneelil kuvatavaid välju.<br/><br/>Veerg <b>Peidetud</b> sisaldab välju, mille saab lisada veergu Vaikimisi.<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Viitab väljale Sõltuv, mis valemi väärtusest olenevalt võib olla nähtav või mitte.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Viitab väljale Arvutatud, mille väärtus arvutatakse valemi põhjal automaatselt.',
    ...
    'listViewEditor' => 
    array (
      'modify' => 'Kõik väljad, mida saab kuvada suvandis <b>Loendivaade</b>, kuvatakse siin.<br><br>Veerg <b>Vaikimisi</b> sisaldab välju, mis kuvatakse suvandis Loendivaade vaikimisi.<br/><br/>Veerg <b>Saadaval</b> sisaldab välju, mida kasutaja saab suvandis Otsing kohandatud loendivaate loomiseks kasutada. <br/><br/>Veerg <b>Peidetud</b> sisaldab välju, mille saab lisada veergu Vaikimisi või Saadaval.<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Viitab väljale Sõltuv, mis valemi väärtusest olenevalt võib olla nähtav või mitte.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Viitab väljale Arvutatud, mille väärtus arvutatakse valemi põhjal automaatselt.',
      'savebtn' => 'Klõpsake nuppu <b>Salvesta ja juuruta</b> tehtud muudatuste salvestamiseks ja nende moodulis aktiivseks muutmiseks.',
    ...
    'popupListViewEditor' => 
    array (
      'modify' => 'Kõik väljad, mida saab kuvada suvandis <b>Loendivaade</b>, kuvatakse siin.<br><br>Veerg <b>Vaikimisi</b> sisaldab välju, mis kuvatakse suvandis Loendivaade vaikimisi.<br/><br/>Veerg <b>Peidetud</b> sisaldab välju, mille saab lisada veergu Vaikimisi või Saadaval.<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Viitab väljale Sõltuv, mis valemi väärtusest olenevalt võib olla nähtav või mitte.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Viitab väljale Arvutatud, mille väärtus arvutatakse valemi põhjal automaatselt.',
      'savebtn' => 'Klõpsake nuppu <b>Salvesta ja juuruta</b> tehtud muudatuste salvestamiseks ja nende moodulis aktiivseks muutmiseks.',
      'historyBtn' => 'Klõpsake nuppu <b>Vaata ajalugu</b> eelnevalt salvestatud paigutuse vaatamiseks ja taastamiseks ajaloost.<br><br><b>Taasta</b> suvandis <b>Vaata ajalugu</b> taastab välja paigutuse eelnevalt salvestatud paigutustes. Välja siltide muutmiseks klõpsake iga välja kõrval olevat ikooni Redigeeri.',
      'historyRestoreDefaultLayout' => 'Klõpsake suvandit <b>Taasta vaikepaigutus</b> vaate algpaigutuse taastamiseks.<br><br><b>Taasta vaikepaigutus</b> taastab välja paigutuse ainult algpaigutuses. Välja siltide muutmiseks klõpsake iga välja kõrval olevat ikooni Redigeeri.',
      'Hidden' => '<b>Peidetud</b> väljad pole praegu kasutajatele loendivaadetes vaatamiseks saadaval.',
    ...
    'searchViewEditor' => 
    array (
      'modify' => 'Kõik väljad, mida saab kuvada vormis <b>Otsing</b>, kuvatakse siin.<br><br>Veerg <b>Vaikimisi</b> sisaldab vormis Otsing kuvatavaid välju.<br/><br/>Veerg <b>Peidetud</b> sisaldab välju, mis on teile kui administraatorile vormi Otsing lisamiseks saadaval.<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Viitab väljale Sõltuv, mis valemi väärtusest olenevalt võib olla nähtav või mitte.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Viitab väljale Arvutatud, mille väärtus arvutatakse valemi põhjal automaatselt.<br/><br/>See konfiguratsioon kehtib ainult pärandi moodulite hüpikotsingu paigutuse puhul.',
...
',
  ...
  'LBL_CONFIRM_FIELD_DELETE' => 'Selle kohandatud välja kustutamine kustutab nii kohandatud välja kui ka kõik andmebaasis kohandatud väljaga seotud andmed. Välja ei kuvata enam üheski mooduli paigutuses. Kui väli on kaasatud mis tahes väljade väärtuste arvutamise valemisse, siis see valem enam ei toimi.\\n\\nVäli pole enam aruannetes kasutamiseks saadaval; see muudatus hakkab kehtima pärast rakendusest välja ja uuesti sisse logimist. Välja sisaldavaid aruandeid tuleb värskendada, et neid oleks võimalik käivitada.\\n\\nKas soovite jätkata?',
  ...
  'LBL_POPHELP_VALIDATE_US_PHONE' => 'Valige selle välja valideerimine 10-kohalise<br>telefoninumbri sisestamiseks, lubades riigikoodi 1 ja<br>USA vormingu rakendamise telefoninumbri puhul kirje<br>salvestamisel. Rakendatakse järgmist vormingut: (xxx) xxx-xxxx.',
