...
$mod_strings = array (
  ...
  'LBL_DELETE' => 'Izbriši',
  'LBL_POWERED_BY_SUGAR' => 'Omogućuje SugarCRM',
  'LBL_ROLE' => 'Uloga',
  'help' => 
  array (
    'package' => 
    ...
    'subPanelEditor' => 
    array (
      'modify' => 'Sva polja koja se mogu prikazati na <b>podploči</b> prikazuju se ovdje.<br><br><b>Zadani</b> stupac sadrži polja prikazana na podploči.<br/><br/><b>Skriveni</b> stupac sadrži polja koja se mogu dodati zadanom stupcu.<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Označava zavisno polje koje može ili ne mora biti vidljivo na temelju vrijednosti formule.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Označava izračunato polje čija će se vrijednost automatski odrediti na temelju formule.',
    ...
    'popupListViewEditor' => 
    array (
      'modify' => 'Sva polja koja se mogu prikazati na <b>prikazu popisa</b> prikazuju se ovdje.<br><br><b>Zadani</b> stupac sadrži polja koja su zadano prikazana u prikazu popisa.<br/><br/><b>Skriveni</b> stupac sadrži polja koja se mogu dodati zadanom ili dostupnom stupcu.<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Označava zavisno polje koje može ili ne mora biti vidljivo na temelju vrijednosti formule.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Označava izračunato polje čija će se vrijednost automatski odrediti na temelju formule.',
      'savebtn' => 'Kliknite na <b>Spremi i implementiraj</b> da biste spremili promjene i da biste ih aktivirali unutar modula.',
      'historyBtn' => 'Kliknite na <b>Prikaži povijest</b> da biste vidjeli i vratili prethodno spremljeni izgled iz povijesti.<br><br><b>Vrati</b> unutar <b>Prikaza povijesti</b> vraća smještaj polja unutar prethodno spremljenih izgleda. Da biste promijenili oznake polja, kliknite na ikonu za uređivanje pokraj svakog polja.',
      'historyRestoreDefaultLayout' => 'Kliknite na <b>Vrati zadani izgled</b> da biste vratili prikaz na njegov izvorni izgled.<br><br><b>Vrati zadani izgled</b> vraća smještaj polja samo unutar izvornog izgleda. Da biste promijenili oznake polja, kliknite na ikonu za uređivanje pokraj svakog polja.',
      'Hidden' => '<b>Skrivena</b> polja trenutačno nisu dostupna da ih korisnici vide u prikazima popisa.',
    ...
    'searchViewEditor' => 
    array (
      'modify' => 'Sva polja koja se mogu prikazati u obrascu za <b>pretraživanje</b> prikazuju se ovdje.<br><br><b>Zadani</b> stupac sadrži polja koja će se prikazivati u obrascu za pretraživanje.<br/><br/><b>Skriveni</b> stupac sadrži dostupna polja koja vi kao administrator možete dodati u obrazac za pretraživanje.<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Označava zavisno polje koje može ili ne mora biti vidljivo na temelju vrijednosti formule.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Označava izračunato polje čija će se vrijednost automatski odrediti na temelju formule.<br/><br/>Ova se konfiguracija primjenjuje na izgled skočnog pretraživanja samo u modulima nasljeđa.',
...
',
  ...
  'LBL_CONFIRM_FIELD_DELETE' => 'Brisanjem ovog prilagođenog polja izbrisat će se prilagođeno polje i svi podaci povezani s prilagođenim poljem u bazi podataka. Polje se više neće pojavljivati u izgledima modula. Ako je polje uključeno u formulu za izračunavanje vrijednosti za polja, formula više neće raditi.\\n\\nPolje više neće biti dostupno za upotrebu u izvješćima; ova će se promjena primijeniti nakon odjave i ponovne prijave u aplikaciju. Izvješća koja sadrže polje morat će se ažurirati da bi mogla raditi.\\n\\nŽelite li nastaviti?',
  ...
  'LBL_POPHELP_DUPLICATE_MERGE' => '<b>Omogućeno</b>: polje će se prikazati u značajki Spajanje duplikata, no neće biti dostupno za upotrebu za uvjete filtra u značajki Traženje duplikata.<br><b>Onemogućeno</b>: polje se neće prikazati u značajki Spajanje duplikata i neće biti dostupno za upotrebu za uvjete filtra u značajki Traženje duplikata.<br><b>U filtru</b>: polje će se prikazati u značajki Spajanje duplikata i bit će dostupno za upotrebu u značajki Traženje duplikata.<br><b>Samo filtar</b>: polje se neće prikazati u značajki Spajanje duplikata, no bit će dostupno za upotrebu u značajki Traženje duplikata.<br><b>Zadani odabrani filtar</b>: polje će se zadano upotrijebiti za uvjet filtra na stranici traženja duplikata te će se prikazati u značajki Spajanje duplikata.',
  'LBL_POPHELP_CALCULATED' => 'Stvorite formulu za određivanje vrijednosti u ovom polju.<br>Definicije tijeka rada koje sadržavaju radnju i koje su postavljene za ažuriranje ovog polja više neće izvršavati radnju.<br>Polja koja se koriste formulama neće se izračunati u stvarnom vremenu na samoslužnom portalu Sugar ili u izgledima Mobilnog prikaza za uređivanje.',
  'LBL_POPHELP_DEPENDENT' => 'Stvorite formulu za određivanje hoće li ovo polje biti vidljivo u izgledima.<br/>Zavisna polja slijedit će formulu zavisnosti u mobilnom prikazu utemeljenom na pregledniku,<br/>no neće slijediti formulu u izvornim aplikacijama, kao što je Sugar Mobile za iPhone.<br/>Neće slijediti formulu u samoslužnom portalu Sugar.',
  ...
  'LBL_POPHELP_VALIDATE_US_PHONE' => 'Odaberite da biste provjerili valjanost ovog polja za unos deseteroznamenkastog<br>telefonskog broja, s dopuštenjem za pozivni broj zemlje 1 i<br>i da biste primijenili format SAD-a na telefonski broj pri spremanju<br>zapisa. Bit će primijenjen sljedeći format: (xxx) xxx-xxxx.',
