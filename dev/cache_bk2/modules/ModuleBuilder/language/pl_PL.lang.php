...
$mod_strings = array (
  ...
  'LBL_DELETE' => 'Usuń',
  'LBL_POWERED_BY_SUGAR' => 'Oparte na systemie SugarCRM',
  'LBL_ROLE' => 'Rola',
  'help' => 
  array (
    'package' => 
    ...
    'subPanelEditor' => 
    array (
      'modify' => 'Wszystkie pola, które można wyświetlać w <b>Panelu podrzędnym</b>, są wyświetlane tutaj.<br><br>Kolumna <b>Domyślne</b> zawiera pola wyświetlane domyślnie w panelu podrzędnym.<br/><br/>Kolumna <b>Ukryte</b> zawiera pola, które można dodać do kolumny Domyślne.<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Określa pole zależne, które może być widoczne lub niewidoczne w zależności od wartości wzoru.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Określa obliczone pole, którego wartość zostanie automatycznie określona na podstawie wzoru.',
    ...
    'listViewEditor' => 
    array (
      'modify' => 'Wszystkie pola, które można wyświetlać w <b>Widoku listy</b>, są wyświetlane tutaj.<br><br>Kolumna <b>Domyślne</b> zawiera pola wyświetlane domyślnie w widoku listy.<br/><br/>Kolumna <b>Dostępne</b> zawiera pola, które użytkownik może wybrać w polu Wyszukiwanie, aby utworzyć niestandardowy widok listy. <br/><br/>Kolumna <b>Ukryte</b> zawiera pola, które można dodać do kolumn Domyślne lub Dostępne.<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Określa pole zależne, które może być widoczne lub niewidoczne w zależności od wartości wzoru.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Określa obliczone pole, którego wartość zostanie automatycznie określona na podstawie wzoru.',
      'savebtn' => 'Kliknij <b>Zapisz i zamieść</b>, aby zachować zmiany i aktywować je w module.',
    ...
    'searchViewEditor' => 
    array (
      'modify' => 'Wszystkie pola, które można wyświetlać w formularzu <b>Wyszukiwanie</b>, są wyświetlane tutaj.<br><br>Kolumna <b>Domyślne</b> zawiera pola wyświetlane w formularzu Wyszukiwanie.<br/><br/>Kolumna <b>Ukryte</b> zawiera pola, które można dodać do formularza Wyszukiwanie.<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Określa pole zależne, które może być widoczne lub niewidoczne w zależności od wartości wzoru.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Określa obliczone pole, którego wartość zostanie automatycznie określona na podstawie wzoru.<br/><br/>Ta konfiguracja ma zastosowanie do układu wyszukiwania w wyskakującym okienku tylko w starszych modułach.',
    ...
    'layoutEditor' => 
    array (
      'defaultdetailview' => 'Obszar <b>Układ</b> zawiera pola, które są aktualnie wyświetlane w ramach formularza <b>Widok szczegółowy</b>.<br/><br/>Obszar <b>Narzędzia</b> zawiera <b>Kosz</b> oraz pola i elementy układu, które można dodać do układu.<br><br>Zmiany w układzie wprowadza się, przeciągając elementy i upuszczając je pomiędzy obszarami <b>Narzędzia</b> i <b>Układ</b> oraz z samym układzie.<br><br>Aby usunąć pole z układu, przeciągnij pole do <b>Kosza</b>. Pole będzie wówczas dostępne w obszarze Narzędzia do dodania do układu.<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Określa pole zależne, które może być widoczne lub niewidoczne w zależności od wartości wzoru.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Określa obliczone pole, którego wartość zostanie automatycznie określona na podstawie wzoru.',
      'defaultquickcreate' => 'Obszar <b>Układ</b> zawiera pola, które są aktualnie wyświetlane w ramach formularza <b>Szybkie tworzenie</b>.<br><br>Formularz Szybkie tworzenie jest wyświetlany w panelach podrzędnych modułu po kliknięciu przycisku Utwórz.<br/><br/>Obszar <b>Narzędzia</b> zawiera <b>Kosz</b> oraz pola i elementy układu, które można dodać do układu.<br><br>Zmiany w układzie wprowadza się, przeciągając elementy i upuszczając je pomiędzy obszarami <b>Narzędzia</b> i <b>Układ</b> oraz w samym układzie.<br><br>Aby usunąć pole z układu, przeciągnij pole do <b>Kosza</b>. Pole będzie wówczas dostępne w obszarze Narzędzia do dodania do układu.<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Określa pole zależne, które może być widoczne lub niewidoczne w zależności od wartości formuły.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Określa obliczone pole, którego wartość zostanie automatycznie określona na podstawie formuły.',
...
',
  ...
  'LBL_CONFIRM_FIELD_DELETE' => 'Usunięcie tego pola niestandardowego spowoduje usunięcie zarówno pola niestandardowego, jak i danych powiązanych z polem niestandardowym w bazie danych. Pole nie będzie dłużej wyświetlane w żadnym układzie modułu. Jeśli to pole jest uwzględnione we wzorze obliczania wartości dla jakichkolwiek pól, wzór tej przestanie działać.\\n\\nTo pole nie będzie już dostępne do użycia w Raportach; ta zmiana będzie obowiązywać od wylogowania i ponownego zalogowania do aplikacji. Wszelkie raporty zawierające to pole należy zaktualizować, aby można je było uruchomić.\\n\\nCzy chcesz kontynuować?',
  ...
  'LBL_POPHELP_DUPLICATE_MERGE' => '<b>Włączone</b>: to pole będzie wyświetlane w funkcji Scalanie duplikatów, ale nie będzie go można użyć dla warunków filtra w funkcji Znajdź duplikaty.<br><b>Wyłączone</b>: to pole nie będzie wyświetlane w funkcji Scalanie duplikatów i nie będzie dostępne do użycia dla warunków filtra w funkcji Znajdź duplikaty.<br><b>W filtrze</b>: pole będzie wyświetlane w funkcji Scalanie duplikatów, a także będzie dostępne w funkcji Znajdź duplikaty.<br><b>Tylko filtr</b>: pole nie będzie wyświetlane w funkcji Scalanie duplikatów, ale będzie dostępne w funkcji Znajdź duplikaty.<br><b>Domyślny wybrany filtr</b>: pole będzie użyte dla warunku filtra domyślnie na stronie Znajdź duplikaty i będzie również wyświetlane w funkcji Scalanie duplikatów.',
  'LBL_POPHELP_CALCULATED' => 'Utwórz formułę służącą do określania wartości tego pola.<br>Definicje workflow zawierające czynność, które mają aktualizować wartość tego pola, nie będą już wykonywać danej czynności.<br>Pola wykorzystujące formuły nie będą obliczane w czasie rzeczywistym w układach Portal samoobsługowy Sugar ani Mobilny widok edycji.',
  'LBL_POPHELP_DEPENDENT' => 'Utwórz formułę służącą do określania, czy to pole jest widoczne w układach.<br/>Pola zależne będą zgodne z formułą zależności w mobilnym widoku przeglądarki,<br/>ale nie będą zgodne z formułą w aplikacjach natywnych, takich jak Sugar Mobile for iPhone.<br/>Nie będą zgodne z formułą w portalu samoobsługowym Sugar.',
  ...
  'LBL_POPHELP_VALIDATE_US_PHONE' => 'Wybierz, aby zweryfikować to pole pod kątem wprowadzenia 10-cyfrowej wartości<br>numeru telefonu z uwzględnieniem kodu kraju 1 oraz <br>zastosowania amerykańskiego formatu numeru telefonu, gdy rekord<br>jest zapisywany. Zastosowany zostanie następujący format: (xxx) xxx-xxxx.',
