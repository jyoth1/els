...
$mod_strings = array (
  ...
  'LBL_DELETE' => 'Naikinti',
  'LBL_POWERED_BY_SUGAR' => 'Teikia „SugarCRM“',
  'LBL_ROLE' => 'Vaidmuo',
  'help' => 
  array (
    'package' => 
    ...
    'listViewEditor' => 
    array (
      'modify' => 'Visi laukai, kurie gali būti rodomi <b>ListView</b>, pateikiami čia.<br><br>Stulpelyje <b>Default</b> yra laukai, kurie pagal numatytuosius parametrus rodomi „ListView“.<br/><br/>Stulpelyje <b>Available</b> yra laukai, kuriuos naudotojas gali rinktis ieškoje ir kurti savo pasirinktinį „ListView“. <br/><br/>Stulpelyje <b>Hidden</b> yra laukai, kuriuos galima įtraukti į stulpelius „Default“ ir „Available“.<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.',
      'savebtn' => 'Paspauskite <b>Išsaugoti ir išdėstyti</b> norint išsaugoti pakeitimus, kuriuos padarėte ir padaryti juos aktyvius modulyje.',
      'historyBtn' => 'Paspauskite <b>Rodyti istorija</b> peržiūrėti ir atstatyti anksčiau išsaugotus istorijos išdėstymus.',
  ...
  'LBL_CONFIRM_FIELD_DELETE' => 'Pašalinus šį pasirinktinį lauką bus pašalintas ir laukas, ir visi su pasirinktiniu lauku susiję duomenys duomenų bazėje. Laukas nebebus rodomas nė viename modulio makete. Jei šis laukas bus įtrauktas į formulę skaičiuoti bet kurių laukų vertėms, formulė nebeveiks.\\n\\nLauko nebebus galima naudoti ataskaitose; šis pakeitimas įsigalios atsijungus ir vėl prisijungus prie programos. Visos ataskaitos, kuriose yra laukas, turės būti atnaujintos, kad būtų galima jas vykdyti.\\n\\nAr norite tęsti?',
  ...
  'LBL_POPHELP_DUPLICATE_MERGE' => '<b>Enabled</b>: laukas rodomas dublikatų suliejimo funkcijoje, tačiau jo negalima naudoti filtro sąlygai dublikatų ieškos funkcijoje.<br><b>Disabled</b>: laukas nerodomas dublikatų suliejimo funkcijoje ir jo negalima naudoti filtro sąlygai dublikatų ieškos funkcijoje.<br><b>In Filter</b>: laukas rodomas dublikatų suliejimo funkcijoje ir galima jį naudoti dublikatų ieškos funkcijoje.<br><b>Filter Only</b>: laukas neveikia dublikatų suliejimo funkcijoje, tačiau jį galima naudoti dublikatų ieškos funkcijoje.<br><b>Default Selected Filter</b>: laukas pagal numatytuosius parametrus naudojamas filtro sąlygai dublikatų ieškos puslapyje, jis rodomas ir dublikatų suliejimo funkcijoje.',
  'LBL_POPHELP_CALCULATED' => 'Sukurkite formulę, kad nustatytumėte šio lauko reikšmę.<br>Darbo sekos, į kurias įtrauktas veiksmas ir kurios yra nustatytos atnaujinti šį lauką, nebegalės vykdyti veiksmo.<br>Laukų, kuriuose yra formulių, reikšmės nebus apskaičiuojamos realiuoju laiku „Sugar“ savitarnos portale ir mobiliojo redagavimo rodinio išdėstymuose.',
  'LBL_POPHELP_DEPENDENT' => 'Sukurkite formulę, kad nustatytumėte, ar šis laukas matomas išdėstymuose.<br/>Priklausomų laukų reikšmės bus apskaičiuojamos pagal formulę, naudojamą mobiliojoje interneto naršyklėje, <br/>tačiau ne pagal formulę, kuri naudojama vietinėse programose, pvz., „Sugar Mobile“, skirtoje „iPhone“. <br/>Jos nebus apskaičiuojamos pagal formulę, naudojamą „Sugar“ savitarnos portale.',
  ...
  'LBL_POPHELP_VALIDATE_US_PHONE' => 'Select to validate this field for the entry of a 10-digit<br>phone number, with allowance for the country code 1, and<br>to apply a U.S. format to the phone number when the record<br>išsaugota. Bus pritaikytas toks formatas: (xxx) xxx-xxxx.',
