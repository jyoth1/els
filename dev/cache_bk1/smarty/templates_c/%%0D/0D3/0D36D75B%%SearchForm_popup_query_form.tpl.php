<?php /* Smarty version 2.6.11, created on 2019-05-26 15:01:42
         compiled from cache/modules/Users/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Users/SearchForm_popup_query_form.tpl', 28, false),array('function', 'math', 'cache/modules/Users/SearchForm_popup_query_form.tpl', 29, false),array('function', 'sugar_getimagepath', 'cache/modules/Users/SearchForm_popup_query_form.tpl', 37, false),array('function', 'sugar_translate', 'cache/modules/Users/SearchForm_popup_query_form.tpl', 46, false),array('function', 'html_options', 'cache/modules/Users/SearchForm_popup_query_form.tpl', 164, false),array('function', 'sugar_getimage', 'cache/modules/Users/SearchForm_popup_query_form.tpl', 620, false),)), $this); ?>
...
' title=''      >
		...
		<?php if ($this->_tpl_vars['fields']['user_name_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
<?php echo smarty_function_html_options(array('id' => 'status_advanced','name' => 'status_advanced[]','options' => $this->_tpl_vars['fields']['status_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['status_advanced']['value']), $this);?>
		...
		<?php if ($this->_tpl_vars['fields']['is_admin_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
> <?php echo $this->_tpl_vars['APP']['LBL_SEARCH_DROPDOWN_YES']; ?>
		...
		<?php if ($this->_tpl_vars['fields']['title_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
' title=''      >
		...
		<?php if ($this->_tpl_vars['fields']['is_group_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
> <?php echo $this->_tpl_vars['APP']['LBL_SEARCH_DROPDOWN_YES']; ?>
		...
		<?php if ($this->_tpl_vars['fields']['department_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
' title=''      >
		...
		<?php if ($this->_tpl_vars['fields']['address_postalcode_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
...
' title=''      >
		...
		<?php if ($this->_tpl_vars['fields']['address_country_advanced']['acl'] > 0): ?>
		<?php echo smarty_function_counter(array('assign' => 'index'), $this);?>
