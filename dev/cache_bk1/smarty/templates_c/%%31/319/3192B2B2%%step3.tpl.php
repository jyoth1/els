...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_csrf_form_token', 'modules/Import/tpls/step3.tpl', 20, false),array('function', 'sugar_help', 'modules/Import/tpls/step3.tpl', 71, false),array('modifier', 'escape', 'modules/Import/tpls/step3.tpl', 27, false),)), $this); ?>
...
">
<input type="hidden" name="source" value="<?php echo ((is_array($_tmp=$_REQUEST['source'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'UTF-8') : smarty_modifier_escape($_tmp, 'html', 'UTF-8')); ?>
">
