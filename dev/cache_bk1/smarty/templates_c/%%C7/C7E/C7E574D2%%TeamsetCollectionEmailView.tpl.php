...
_primary" rowspan='1' scope='row' style='white-space: nowrap; word-wrap: normal;'>
        ...
        <?php if ($this->_tpl_vars['isTBAEnabled']): ?>
...
_selected" rowspan='1' scope='row'
                ...
                <?php echo smarty_function_sugar_translate(array('label' => 'LBL_TEAM_SET_SELECTED'), $this);?>
...
_<?php echo $this->_tpl_vars['vardef']['name']; ?>
' style="text-decoration:none;" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_HIDE_SHOW'), $this);?>
">
...
_<?php echo $this->_tpl_vars['vardef']['name']; ?>
" ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SHOW'), $this);?>
</span>
        	</span>
        	<?php endif; ?>
        </td>
...
_checkbox_div_0'>
            &nbsp;
            <input id="selected_<?php echo $this->_tpl_vars['vardef']['name']; ?>
_collection_0" name="selected_<?php echo $this->_tpl_vars['vardef']['name']; ?>
_collection_0"
                   type="checkbox" class="checkbox" value="<?php echo $this->_tpl_vars['values']['primary']['id']; ?>
"
                   <?php if ($this->_tpl_vars['values']['primary']['selected']): ?>checked="checked"
                   title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TEAM_TBSELECTED_TITLE'), $this);?>
"
                   <?php else: ?>title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TEAM_SELECT_AS_TBSELECTED_TITLE'), $this);?>
"<?php endif; ?>/>
            </span>
            </td>
        <?php endif; ?>
...
';
			<?php if ($this->_tpl_vars['isTBAEnabled']): ?>temp_array['selected'] = '<?php echo $this->_tpl_vars['secondary_field']['selected']; ?>
';<?php endif; ?>
			collection["<?php echo $this->_tpl_vars['displayParams']['formName']; ?>
_<?php echo $this->_tpl_vars['vardef']['name']; ?>
