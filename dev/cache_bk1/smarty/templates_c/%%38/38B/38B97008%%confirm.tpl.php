<?php /* Smarty version 2.6.11, created on 2019-05-27 09:32:07
         compiled from modules/Import/tpls/confirm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_csrf_form_token', 'modules/Import/tpls/confirm.tpl', 19, false),array('function', 'sugar_help', 'modules/Import/tpls/confirm.tpl', 47, false),array('function', 'html_options', 'modules/Import/tpls/confirm.tpl', 103, false),array('modifier', 'escape', 'modules/Import/tpls/confirm.tpl', 22, false),)), $this); ?>
...
">
<input type="hidden" name="source" id="source" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['SOURCE'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'UTF-8') : smarty_modifier_escape($_tmp, 'html', 'UTF-8')); ?>
">
...
> <?php echo smarty_function_sugar_help(array('text' => $this->_tpl_vars['MOD']['LBL_HEADER_ROW_OPTION_HELP']), $this);?>
                    ...
                    <tr>
                        <td scope="col"><slot><label for="sigDigits"><?php echo $this->_tpl_vars['MOD']['LBL_SYSTEM_SIG_DIGITS']; ?>
:</label></slot></td>
