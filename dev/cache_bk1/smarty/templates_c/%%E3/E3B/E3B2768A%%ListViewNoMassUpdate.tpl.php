<?php /* Smarty version 2.6.11, created on 2019-05-26 14:23:54
         compiled from include/ListView/ListViewNoMassUpdate.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'include/ListView/ListViewNoMassUpdate.tpl', 24, false),array('function', 'sugar_translate', 'include/ListView/ListViewNoMassUpdate.tpl', 29, false),array('function', 'sugar_getimage', 'include/ListView/ListViewNoMassUpdate.tpl', 34, false),array('function', 'sugar_evalcolumn_old', 'include/ListView/ListViewNoMassUpdate.tpl', 77, false),array('function', 'sugar_field', 'include/ListView/ListViewNoMassUpdate.tpl', 79, false),array('modifier', 'default', 'include/ListView/ListViewNoMassUpdate.tpl', 27, false),array('modifier', 'lower', 'include/ListView/ListViewNoMassUpdate.tpl', 29, false),)), $this); ?>
...
' class='listViewThLinkS1' title=$arrowAlt><?php echo smarty_function_sugar_translate(array('label' => $this->_tpl_vars['params']['label'],'module' => $this->_tpl_vars['pageData']['bean']['moduleDir']), $this);?>
&nbsp;&nbsp;
...
" href="javascript:parent.SUGAR.App.router.navigate(parent.SUGAR.App.router.buildRoute('<?php echo $this->_tpl_vars['pageData']['bean']['moduleDir']; ?>
', '<?php echo $this->_tpl_vars['rowData']['ID']; ?>
'), <?php echo '{'; ?>
trigger: true<?php echo '}'; ?>
...
'; ?>
        ...
        var url = '#bwc/index.php?module=' + m + '&offset=' + offset + '&stamp=<?php echo $this->_tpl_vars['pageData']['stamp']; ?>
&return_module=' +
